# coding=UTF-8
import os
from bascisetting_supplier_page import *
...
if __name__ == '__main__':
    ...
    pytest.main(['-s', 'D:/Pycharm/UiYunDaiZhang/UI2/class_pytest_webdriver的副本/test_case/test_case_basic/test_case_basic_supplier.py', '--alluredir',
