# coding=UTF-8
import os
from page_objeck.Basic.basicsetting.basicsetting_auxiliaryinformation_page import *
...
class TestCaseauxiliaryinformation():
    ...
    @pytest.mark.parametrize('udata', loadyaml(
        'D:/Pycharm/UiYunDaiZhang/UI2/class_pytest_webdriver的副本/data/basic/BaseData/auxiliaryinformation/add.yaml'))
    ...
    @allure.feature("基础资料-辅助资料模块")
    @allure.story("查询辅助资料")
    @pytest.mark.parametrize('udata', loadyaml('D:/Pycharm/UiYunDaiZhang/UI2/class_pytest_webdriver的副本/data/basic/BaseData/auxiliaryinformation/query.yaml'))
    ...
    @pytest.mark.parametrize('udata', loadyaml('D:/Pycharm/UiYunDaiZhang/UI2/class_pytest_webdriver的副本/data/basic/BaseData/auxiliaryinformation/change.yaml'))
    ...
    @pytest.mark.parametrize('udata', loadyaml(
        'D:/Pycharm/UiYunDaiZhang/UI2/class_pytest_webdriver的副本/data/basic/BaseData/auxiliaryinformation/delete.yaml'))
...
if __name__ == '__main__':
    ...
    pytest.main(
        ['-s', 'D:/Pycharm/UiYunDaiZhang/UI2/class_pytest_webdriver的副本/test_case/test_case_basic/test_case_basic_basesetting/test_case_basic_auxiliaryinformation.py',
