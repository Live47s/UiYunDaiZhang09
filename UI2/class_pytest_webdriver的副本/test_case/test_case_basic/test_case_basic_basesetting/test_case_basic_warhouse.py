# coding=UTF-8
import os
from page_objeck.Basic.basicsetting.basicsetting_warhouse_page import *
...
class TestCaseWarhouse():
    ...
    def test_2_add_warhouse(self, udata, init_driver):
        '''基础设置-新增客户用例'''
        self.lp = Basic_Setting_Warhouse(init_driver).add_Warhouse(udata['customerName'])
...
if __name__ == '__main__':
    ...
    pytest.main(
        ['-s', 'D:/Pycharm/UiYunDaiZhang/UI2/class_pytest_webdriver的副本/test_case/test_case_basic/test_case_basic_basesetting/test_case_basic_warhouse.py',
