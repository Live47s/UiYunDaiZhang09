# coding=UTF-8
import os
from page_objeck.Basic.basicsetting.bascisetting_inventory_page import *
...
class TestCaseInvertory():
    ...
    @pytest.mark.parametrize('udata', loadyaml(
        'D:/Pycharm/UiYunDaiZhang/UI2/class_pytest_webdriver的副本/data/basic/BaseData/Inventory/add.yaml'))
    ...
    @allure.feature("基础资料-存货模块")
    @allure.story("查询存货")
    @pytest.mark.parametrize('udata', loadyaml('D:/Pycharm/UiYunDaiZhang/UI2/class_pytest_webdriver的副本/data/basic/BaseData/Inventory/query.yaml'))
    ...
    @allure.feature("基础资料-存货模块")
    @allure.story("修改存货名称")
    @pytest.mark.parametrize('udata', loadyaml('D:/Pycharm/UiYunDaiZhang/UI2/class_pytest_webdriver的副本/data/basic/BaseData/Inventory/change.yaml'))
    ...
    @allure.story("删除单个存货")
    @pytest.mark.parametrize('udata', loadyaml(
        'D:/Pycharm/UiYunDaiZhang/UI2/class_pytest_webdriver的副本/data/basic/BaseData/Inventory/delete.yaml'))
...
if __name__ == '__main__':
    ...
    pytest.main(
        ['-s', 'D:/Pycharm/UiYunDaiZhang/UI2/class_pytest_webdriver的副本/test_case/test_case_basic/test_case_basic_basesetting/test_case_basic_invertory.py',
