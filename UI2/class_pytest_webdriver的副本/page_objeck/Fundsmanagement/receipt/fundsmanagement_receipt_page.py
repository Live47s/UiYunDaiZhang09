...
class Fund_Management_receipt(BasePage):
    # 核心元素
    data = loadyaml('D:/Pycharm/UiYunDaiZhang/UI2/class_pytest_webdriver的副本/data/fundsmanagement/receipt/InsertInDatabase.yaml')
    ...
    # 基础资料 新增收款单
    def add_receipt(self,receiptName):
        try:

            if receiptName == "UI自动化新增收款单003":
                ...
                link1 = self.driver.find_element(By.XPATH, '//*[@id="receipt"]/div[2]/div[5]/div/div/input')
            ...
            elif receiptName == "UI自动化新增收款单001":
                time.sleep(2)
                # # 点击输入客户名称
                ...
                # 模拟鼠标悬停操作
                action = ActionChains(self.driver)
                link1 = self.driver.find_element(By.XPATH, '//*[@id="receipt"]/div[2]/div[2]/div/div/input')
                action.move_to_element(link1).perform()
                time.sleep(1)
                # 移动鼠标点击存货价格设置
                action.move_by_offset(0, 30).click()
            ...
            elif receiptName == "UI自动化新增收款单002":
                self.click(self.resh)
                time.sleep(2)
                # # 点击输入客户名称
                self.input(self.gongyingshang, '单个精准查询')
            ...
            elif receiptName == "UI自动化新增收款单004":
            ...
            elif receiptName == "UI自动化新增收款单005":
                self.click(self.resh)
                time.sleep(2)
                # # 点击输入客户名称
                self.input(self.gongyingshang, '单个精准查询')
    ...
    # 修改
    def change_receipt(self,changegongyingshangName):
        ...
        try:
            ...
            if changegongyingshangName == '修改收款单数据01':
    ...
    # 基础资料 删除单条客户信息
    def delete_receipt(self,deleteName):
        try:
            self.click(self.resh)
            time.sleep(2)
...
if __name__ == '__main__':
    ...
    lp = Fund_Management_receipt(driver)
    # k = lp.add_receipt("UI自动化新增收款单004")
    # lp.seach_receipt("单个精准查询")
    lp.delete_receipt("删除选手")
    # lp.change_receipt("修改收款单数据02")
